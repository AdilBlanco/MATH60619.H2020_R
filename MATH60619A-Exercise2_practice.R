...
hist(assurance$frais[assurance$fumeur=='oui'], freq=FALSE, col="lightblue",
     xlab="fee", main="Smoker", ylab="density")
lines(density(assurance$frais[assurance$fumeur=='oui']), lty=2,col="black", lwd=1)
lines(curve(dnorm(x, mean= mean(assurance$frais[assurance$fumeur=='oui']), 
                  sd=sd(assurance$frais[assurance$fumeur=='oui'])), from=20, to=200, add=TRUE), col="red", lwd=2)
# histogram plot fee for no smokers.
hist(assurance$frais[assurance$fumeur=='non'], freq=FALSE, col="lightblue",
     xlab="fee", main="No smoker", ylab="density")
lines(density(assurance$frais[assurance$fumeur=='non']), lty=2,col="black", lwd=1)
lines(curve(dnorm(x, mean= mean(assurance$frais[assurance$fumeur=='non']), 
                  sd=sd(assurance$frais[assurance$fumeur=='non'])), from=20, to=200, add=TRUE), col="red", lwd=2)
# Normal Quantile-Q plot fee for smokers.
qqnorm(assurance$frais[assurance$fumeur=='oui'], pch=1, main="Smoker", frame=FALSE)
qqline(assurance$frais[assurance$fumeur=='oui'], col="steelblue", lwd=2)
# Normal Quantile-Q plot fee for no smokers.
qqnorm(assurance$frais[assurance$fumeur=='non'], pch=1, main="No smoker", frame=FALSE)
qqline(assurance$frais[assurance$fumeur=='non'], col="steelblue", lwd=2)
# Box plot offer
boxplot(assurance$frais ~ assurance$fumeur, 
        horizontal=TRUE, 
        col="lightblue", 
        xlab="fee", 
        ylab="smoker",
...
hist(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc>=30)], freq=FALSE, col="lightblue",
     xlab="fee", main="Smoker obese.", ylab="density")
lines(density(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc>=30)]), lty=2,col="black", lwd=1)
lines(curve(dnorm(x, mean= mean(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc>=30)]), 
                  sd=sd(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc>=30)])), from=20, to=200, add=TRUE), col="red", lwd=2)
# histogram plot fee for smokers no obese.
hist(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc<30)], freq=FALSE, col="lightblue",
     xlab="fee", main="Smoker no obese.", ylab="density")
lines(density(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc<30)]), lty=2,col="black", lwd=1)
lines(curve(dnorm(x, mean= mean(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc < 30)]), 
                  sd=sd(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc<30)])), from=20, to=200, add=TRUE), col="red", lwd=2)
# Normal Quantile-Q plot fee for smokers obese.
qqnorm(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc>=30)], pch=1, main="Smoker obese.", frame=FALSE)
qqline(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc>=30)], col="steelblue", lwd=2)
# Normal Quantile-Q plot fee for smokers no obese.
qqnorm(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc<30)], pch=1, main="Smoker no obese.", frame=FALSE)
qqline(assurance$frais[(assurance$fumeur=="oui") & (assurance$imc<30)], col="steelblue", lwd=2)
# Box plot offer
boxplot(assurance$frais[assurance$fumeur=="oui"] ~ assurance$is_obese[assurance$fumeur=="oui"], 
        horizontal=TRUE, 
        col="lightblue", 
        xlab="fee", 
...
hist(assurance$imc[assurance$sexe=="femme"], freq=FALSE, col="lightblue",
     xlab="fee", main="Women vs IMC.", ylab="density")
lines(density(assurance$imc[assurance$sexe=="femme"]), lty=2,col="black", lwd=1)
lines(curve(dnorm(x, mean= mean(assurance$imc[assurance$sexe=="femme"]), 
                  sd=sd(assurance$imc[assurance$sexe=="femme"])), from=20, to=200, add=TRUE), 
      col="red", lwd=2)
# histogram plot imc vs men.
hist(assurance$imc[assurance$sexe=="homme"], freq=FALSE, col="lightblue",
     xlab="fee", main="Men vs IMC.", ylab="density")
lines(density(assurance$imc[assurance$sexe=="homme"]), lty=2,col="black", lwd=1)
lines(curve(dnorm(x, mean= mean(assurance$imc[assurance$sexe=="homme"]),
                  sd=sd(assurance$imc[assurance$sexe=="homme"])), from=20, to=200, add=TRUE), 
      col="red", lwd=2)
# Normal Quantile-Q plot imc vs Women.
qqnorm(assurance$imc[assurance$sexe=="femme"], pch=1, main="Women vs IMC.", frame=FALSE)
qqline(assurance$imc[assurance$sexe=="femme"], col="steelblue", lwd=2)
# Normal Quantile-Q plot imc vs men.
qqnorm(assurance$imc[assurance$sexe=="homme"], pch=1, main="Men vs IMC.", frame=FALSE)
qqline(assurance$imc[assurance$sexe=="homme"], col="steelblue", lwd=2)
# Box plot offer
boxplot(assurance$imc ~ assurance$sexe, 
        horizontal=TRUE, 
        col="lightblue", 
        xlab="imc", 
        ylab="smoker & is_obese",
...
assurance$direction <- with(assurance, ifelse(region %in% c("sudouest", "sudest" ), "S", "N"))

par(mfrow=c(3,2), pch=20, bty='l')
# histogram plot imc vs direction Nord
hist(assurance$imc[assurance$direction=="N"], freq=FALSE, col="lightblue",
     xlab="fee", main="North vs IMC.", ylab="density")
lines(density(assurance$imc[assurance$direction=="N"]), lty=2,col="black", lwd=1)
lines(curve(dnorm(x, mean= mean(assurance$imc[assurance$direction=="N"]), 
                  sd=sd(assurance$imc[assurance$direction=="N"])), from=20, to=200, add=TRUE), 
      col="red", lwd=2)
# histogram plot imc vs direction Sud
hist(assurance$imc[assurance$direction=="S"], freq=FALSE, col="lightblue",
     xlab="fee", main="South vs IMC.", ylab="density")
lines(density(assurance$imc[assurance$direction=="S"]), lty=2,col="black", lwd=1)
lines(curve(dnorm(x, mean= mean(assurance$imc[assurance$direction=="S"]),
                  sd=sd(assurance$imc[assurance$direction=="S"])), from=20, to=200, add=TRUE), 
      col="red", lwd=2)
# Normal Quantile-Q plot imc vs direction Nord
qqnorm(assurance$imc[assurance$direction=="N"], pch=1, main="North vs IMC.", frame=FALSE)
qqline(assurance$imc[assurance$direction=="N"], col="steelblue", lwd=2)
# Normal Quantile-Q plot imc vs direction Sud.
qqnorm(assurance$imc[assurance$direction=="S"], pch=1, main="South vs IMC.", frame=FALSE)
qqline(assurance$imc[assurance$direction=="S"], col="steelblue", lwd=2)
# Box plot offer
boxplot(assurance$imc ~ assurance$direction, 
        horizontal=TRUE, 
        col="lightblue", 
        xlab="imc", 
        ylab="Direction",
